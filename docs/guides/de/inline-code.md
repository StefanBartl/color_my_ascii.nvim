...
## Table of content
  ...
  - [Was wird hervorgehoben?](#was-wird-hervorgehoben)
  - [Beispiele](#beispiele)
    - [Keywords](#keywords)
    - [Symbole und Pfeile](#symbole-und-pfeile)
    - [Operatoren](#operatoren)
    - [Funktionsnamen](#funktionsnamen)
  - [Priorität](#prioritt)
  - [Anwendungsfälle](#anwendungsflle)
    - [Dokumentation](#dokumentation)
  - [API Reference](#api-reference)
    - [Code-Erklärungen](#code-erklrungen)
    - [Inline-Diagramme](#inline-diagramme)
  - [Konfiguration](#konfiguration)
    - [Mit gedämpftem Text](#mit-gedmpftem-text)
    - [Mit allen Features](#mit-allen-features)
    - [Nur Symbole, keine Keywords](#nur-symbole-keine-keywords)
  - [Performance](#performance)
    - [Overhead](#overhead)
    - [Debouncing](#debouncing)
  - [Einschränkungen](#einschrnkungen)
    - [Escaped Backticks](#escaped-backticks)
    - [Verschachtelte Backticks](#verschachtelte-backticks)
    - [Code-Spans über Zeilen](#code-spans-ber-zeilen)
  - [Kombination mit ASCII-Blöcken](#kombination-mit-ascii-blcken)
  - [Language Detection](#language-detection)
  - [Best Practices](#best-practices)
    - [Wann aktivieren?](#wann-aktivieren)
    - [Kombination mit Colorschemes](#kombination-mit-colorschemes)
    - [Mit default_text_hl](#mit-default_text_hl)
  - [Troubleshooting](#troubleshooting)
    - [Inline-Code wird nicht hervorgehoben](#inline-code-wird-nicht-hervorgehoben)
    - [Zu viele False Positives](#zu-viele-false-positives)
