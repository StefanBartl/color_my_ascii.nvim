...
return {
  words = {
    ...
    'sealed', 'abstract', 'virtual', 'override', 'readonly', 'const',
    -- Types
    'int', 'long', 'double', 'float', 'decimal', 'bool', 'string', 'char', 'byte', 'void', 'var',
    -- Control flow
    ...
    'true', 'false', 'null',
    -- Common types
    'Console', 'List', 'Dictionary', 'IEnumerable', 'Task',
  },

  -- Keywords unique to C#
  unique_words = {
    'foreach', 'delegate', 'sealed', 'internal', 'Console',
  },
