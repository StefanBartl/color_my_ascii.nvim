...
---@type table<string, string>
local FT = {
  js = "javascript", node = "javascript", jsx = "javascriptreact",
  ts = "typescript", tsx = "typescriptreact",
  py = "python", rb = "ruby", sh = "sh", bash = "sh", shell = "sh", zsh = "sh",
  ["c++"] = "cpp", cxx = "cpp", cc = "cpp", cs = "cs", csharp = "cs",
  kt = "kotlin", golang = "go", rs = "rust", pl = "perl", viml = "vim",
  vimscript = "vim", hs = "haskell", ex = "elixir", clj = "clojure",
  ps1 = "ps1", powershell = "ps1", md = "markdown", yml = "yaml",
  golang_ = "go",
}
--- @param lang string|nil
--- @return string
...
function M.lang_tags()
  ...
  for k in pairs(map) do set[k] = true end
  for k in pairs(EXT) do set[k] = true end
  local out = {}
