...
## Table of content
  ...
  - [Unterstützte Brackets](#untersttzte-brackets)
  - [Highlight-Gruppe](#highlight-gruppe)
  - [Funktionsweise](#funktionsweise)
    - [Automatische Erkennung](#automatische-erkennung)
    - [Priorität](#prioritt)
  - [Beispiele](#beispiele)
    - [C-Syntax](#c-syntax)
    - [Array-Zugriff](#array-zugriff)
    - [Nested Structures](#nested-structures)
  - [Kombination mit anderen Features](#kombination-mit-anderen-features)
    - [Mit Operators Group](#mit-operators-group)
    - [Mit Custom Highlights](#mit-custom-highlights)
  - [Use Cases](#use-cases)
    - [Code-Diagramme](#code-diagramme)
  ...
  - [Einschränkungen](#einschrnkungen)
    - [Keine Matching-Logik](#keine-matching-logik)
    - [Keine Context-Awareness](#keine-context-awareness)
  - [Best Practices](#best-practices)
    - [Wann aktivieren?](#wann-aktivieren)
    - [Kombination mit Color Schemes](#kombination-mit-color-schemes)
  - [Troubleshooting](#troubleshooting)
    - [Brackets werden nicht hervorgehoben](#brackets-werden-nicht-hervorgehoben)
    - [Falsche Highlight-Farbe](#falsche-highlight-farbe)
