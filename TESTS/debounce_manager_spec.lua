...
return function(H)
  ...
  do
    ...
    local lines = {}
    for i = 1, 15 do lines[i] = "line " .. i end
  ...
  do
    ...
    debounce_manager.debounce(buf, function() calls = calls + 1 end)
  ...
  do
    ...
    debounce_manager.debounce(buf, function() calls = calls + 1 end, 15)
    debounce_manager.debounce(buf, function() calls = calls + 1 end, 15) -- supersedes the first
