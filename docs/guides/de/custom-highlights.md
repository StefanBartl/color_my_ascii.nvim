...
## Table of content
  ...
  - [Unterstützte Farb-Formate](#untersttzte-farb-formate)
    - [Hex-Farben](#hex-farben)
    - [Farbnamen](#farbnamen)
  - [Text-Styles](#text-styles)
    - [Verfügbare Styles](#verfgbare-styles)
  - [Anwendungsfälle](#anwendungsflle)
    ...
    - [Kombinierte Nutzung](#kombinierte-nutzung)
  - [Character Groups mit Custom Highlights](#character-groups-mit-custom-highlights)
  - [Keyword Highlights](#keyword-highlights)
  - [Praktische Beispiele](#praktische-beispiele)
    - [Matrix-Style (Grüner Hacker-Look)](#matrix-style-grner-hacker-look)
    - [Regenbogen-Ecken](#regenbogen-ecken)
    - [Subtile Dimm-Effekte](#subtile-dimm-effekte)
  - [Troubleshooting](#troubleshooting)
    - [Farben werden nicht angezeigt](#farben-werden-nicht-angezeigt)
    - [Styles funktionieren nicht](#styles-funktionieren-nicht)
